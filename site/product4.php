...
<html>
  ...
  <body>
    ...
    <!-- Image -->
    <div id="main">
    <img src="photos/carpixel.net-2018-ferrari-488-pista-79795-wide.jpg" id="carImage">
      <p id="stats">Brand: Ferrari<br><br>Model: F8 Tributo<br><br>Year: 2021<br><br>Color: red with black and white line<br><br>Engine: 3.5L V8 Twin-Turbo<br><br>Range: 1000 km<br><br>Price: $ 380 000</p>
    </div>
    <h2>Description</h2>
    <p id="description" >
      For sale: Experience the epitome of Italian performance and style with the Ferrari F8 Tributo, a dynamic masterpiece that pays homage to its predecessors while pushing the boundaries of automotive excellence. This mid-engine marvel exudes sophistication and power from every angle, with aerodynamic lines and aggressive styling that command attention on the road or the track. Beneath its sculpted hood lies a ferocious V8 engine, delivering blistering acceleration and a symphony of exhaust notes that thrill the senses. Step inside the luxurious cockpit, where premium materials and cutting-edge technology merge to create an unparalleled driving environment. With precision engineering and race-inspired dynamics, the F8 Tributo offers an exhilarating driving experience that's truly unforgettable. Don't miss your chance to own a piece of Ferrari's storied legacy and embrace the thrill of driving at its finest.
    </p>
